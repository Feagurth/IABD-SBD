...
matriz <- matrix(data = seq(2, 100, by = 2),
    nrow = 10, ncol = 10, byrow = FALSE)

print(matriz)

# 3.- Construya una matriz identidad de dimension  3×3. Recuerde que una matriz
# identidad tiene sólo unos en la diagonal principal y los demás elementos son
# cero.
...
# El error que se produce es: Error in matrix(edad, deporte, comic_fav)
# : non-numeric matrix extent
#
# Esto es debido a que ha intentado crear una matriz con diversos tipos
# de datos distintos cuando una matriz debe tener todos los datos del mismo tipo